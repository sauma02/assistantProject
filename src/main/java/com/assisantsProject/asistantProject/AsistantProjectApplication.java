...
public class AsistantProjectApplication {
    ...
    public CommandLineRunner commandLineRunner(UsuarioRepositorio usuarioRepositorio, RolRepositorio rolRepositorio, PasswordEncoder passwordEncoder) {
        return args -> {
            Usuario usuario = usuarioRepositorio.findByUsuario("user");
            Usuario usuarioAdmin = usuarioRepositorio.findByUsuario("admin");
            ...
            if (rolUser != null && usuario != null) {
                ...
                Usuario user = new Usuario(null, "user", passwordEncoder.encode("12345"), "user@iqor.com", rolUser, null);
                usuarioRepositorio.save(user);

            } else{
                Rol us = new Rol();
                us.setNombre("usuario");
                us.setDescripcion("asistente");
                rolRepositorio.save(us);
                Usuario user = new Usuario(null, "user", passwordEncoder.encode("12345"), "user@iqor.com", us, null);
                usuarioRepositorio.save(user);
            }
            if (usuarioAdmin != null && rolAdmin != null) {
                ...
                Usuario admin = new Usuario(null, "admin", passwordEncoder.encode("12345"), "admin@iqor.com", rolAdmin, null);
                ...
                Usuario admin = new Usuario(null, "admin", passwordEncoder.encode("12345"), "admin@iqor.com", ad, null);
                usuarioRepositorio.save(admin);
            }
        };
